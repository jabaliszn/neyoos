...
(async () => {
  ...
  try {
    ...
    await page.waitForTimeout(4000); // Wait for page elements to render completely

    console.log("Taking screenshot of the Redesigned Executive Dashboard...");
    await page.screenshot({ path: '../dashboard_redesign.png', fullPage: false });
    console.log("Screenshot successfully saved as /home/user/dashboard_redesign.png!");
