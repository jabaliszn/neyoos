...
(async () => {
  ...
  try {
    ...
    await page.waitForTimeout(3000); // Wait for the dashboard and intercom card to load

    console.log("Clicking '📞 Call' button next to Deputy P. Njoroge inside the Neyo Intercom Card...");
    // Find the call button in the staff directory and click it
    await page.click('text="📞 Call"');
    
    console.log("Waiting for WebRTC call connection and voice waves to animate...");
    await page.waitForTimeout(2000); // Wait for ringing state to activate and voice waves to pulse

    console.log("Taking screenshot of the active Intercom voice call...");
    await page.screenshot({ path: '../webrtc_call_screenshot.png', fullPage: false });
    console.log("Screenshot successfully saved as /home/user/webrtc_call_screenshot.png!");
