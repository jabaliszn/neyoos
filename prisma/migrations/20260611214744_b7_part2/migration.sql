...
INSERT INTO "new_Invoice" ("createdAt", "description", "dueDate", "id", "invoiceNo", "paidKes", "status", "structureId", "studentId", "tenantId", "term", "totalKes", "updatedAt", "year") SELECT "createdAt", "description", "dueDate", "id", "invoiceNo", "paidKes", "status", "structureId", "studentId", "tenantId", "term", "totalKes", "updatedAt", "year" FROM "Invoice";
DROP TABLE "Invoice";
