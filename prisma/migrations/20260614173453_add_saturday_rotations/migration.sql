...
INSERT INTO "new_TimetableConfig" ("classId", "coCurricularCount", "coCurricularName", "freePeriodsPerWeek", "hasPreps", "hasRemedials", "id", "lessonDurationMins", "longBreakMins", "longBreakStart", "lunchMins", "lunchShift", "lunchStart", "periodsPerDay", "shortBreakMins", "shortBreakStart", "tenantId") SELECT "classId", "coCurricularCount", "coCurricularName", "freePeriodsPerWeek", "hasPreps", "hasRemedials", "id", "lessonDurationMins", "longBreakMins", "longBreakStart", "lunchMins", "lunchShift", "lunchStart", "periodsPerDay", "shortBreakMins", "shortBreakStart", "tenantId" FROM "TimetableConfig";
...
INSERT INTO "new_TimetableSlot" ("classId", "dayOfWeek", "id", "period", "slotType", "subjectId", "teacherId", "tenantId") SELECT "classId", "dayOfWeek", "id", "period", "slotType", "subjectId", "teacherId", "tenantId" FROM "TimetableSlot";
