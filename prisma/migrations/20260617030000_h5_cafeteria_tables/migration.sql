...
CREATE TABLE "CafeteriaTable" (
    ...
    CONSTRAINT "CafeteriaTable_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
