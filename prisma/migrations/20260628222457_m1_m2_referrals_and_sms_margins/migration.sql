...
CREATE TABLE "SmsMarginLedger" (
    ...
    "costPerSmsKes" REAL NOT NULL,
    "pricePerSmsKes" REAL NOT NULL,
    "marginKes" REAL NOT NULL,
    "status" TEXT NOT NULL DEFAULT 'UNBILLED',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "SmsMarginLedger_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
