...
const OUT = "screenshots/i56-storage-vault.png";
async function main() {
  ...
  await page.goto(`${BASE}/settings/storage`, { waitUntil: "domcontentloaded" });
  await page.waitForSelector("text=NEYO Storage Vault", { timeout: 25000 });
