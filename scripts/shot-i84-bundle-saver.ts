...
async function main(){
 ...
 await page.getByText("NEYO Bundle Saver Mode").scrollIntoViewIfNeeded().catch(()=>{});
 await page.waitForTimeout(500);
 await page.screenshot({path:"screenshots/i84-bundle-saver-mode.png",fullPage:false});
 await browser.close();
 console.log("✓ screenshots/i84-bundle-saver-mode.png");
}
main();
