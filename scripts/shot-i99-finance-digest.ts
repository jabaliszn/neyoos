...
async function main(){
 ...
 await page.getByText("Automated fee digest").scrollIntoViewIfNeeded().catch(()=>{});
 await page.waitForTimeout(500);
 await page.screenshot({path:"screenshots/i99-finance-digest.png",fullPage:false, timeout:60000});
 await browser.close();
 console.log("✓ screenshots/i99-finance-digest.png");
}
main();
