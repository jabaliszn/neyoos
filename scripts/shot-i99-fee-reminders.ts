...
async function main(){
 ...
 await page.getByText("One-tap fee reminders").scrollIntoViewIfNeeded().catch(()=>{});
 await page.waitForTimeout(500);
 await page.screenshot({path:"screenshots/i99-one-tap-fee-reminders.png",fullPage:false});
 await browser.close();
 console.log("✓ screenshots/i99-one-tap-fee-reminders.png");
}
main();
