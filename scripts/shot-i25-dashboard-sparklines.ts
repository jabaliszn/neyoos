...
const OUT = "screenshots/i25-dashboard-sparklines.png";
...
async function main() {
  ...
  await page.waitForSelector("text=Outstanding Fees", { timeout: 20000 });
  await page.waitForSelector("text=Fees Collected Today", { timeout: 20000 });
