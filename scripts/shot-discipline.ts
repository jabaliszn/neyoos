/** B.20 Discipline screenshots (95-96). */
...
async function main() {
  ...
  await page.screenshot({ path: `${SHOTS}/95-discipline-incidents.png` });
  await page.getByRole("button", { name: "Behavior board", exact: true }).click();
  await page.waitForTimeout(1500);
  await page.keyboard.press("Escape");
  await page.screenshot({ path: `${SHOTS}/96-discipline-behavior.png` });
  await browser.close();
  console.log("✓ screenshots 95-96 captured");
}
