...
(async () => {
  ...
  try {
    ...
    console.log("Navigating directly to School Profile Settings...");
    await page.goto('http://localhost:3000/settings/school');
    await page.waitForTimeout(4000); // Wait for the settings page to render completely

    console.log("Taking screenshot of the Custom Theme Builder and Transparency Controls...");
    await page.screenshot({ path: '../settings_screenshot.png', fullPage: false });
    console.log("Screenshot successfully saved as /home/user/settings_screenshot.png!");
